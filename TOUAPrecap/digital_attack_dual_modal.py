...
for net_id in range(0, 1):
    ...
    for pic in file:
        ...
        # Skip if no car detection
        # Check if class 2 exists
        if res_inf1[2].shape[0] == 0 or res_vis1[2].shape[0] == 0:
            print(f"Skipping {pic}: No car detection")
            print(f"Skipping {pic}: No car detection")
            continue
        ...
        shape_inf = res_inf1[2].shape[0]
        shape_vis = res_vis1[2].shape[0]
        ...
        if res_vis1[2][0][0] > (res_inf1[2][0][0] + ((res_inf1[2][0][2] - res_inf1[2][0][0]) / 2)) or res_inf1[2][0][0] > (
                res_vis1[2][0][0] + ((res_vis1[2][0][2] - res_vis1[2][0][0]) / 2)) or res_vis1[2][0][1] > (
                res_inf1[2][0][1] + ((res_inf1[2][0][3] - res_inf1[2][0][1]) / 2)) or res_inf1[2][0][1] > (
                res_vis1[2][0][1] + ((res_vis1[2][0][3] - res_vis1[2][0][1]) / 2)):
        ...
        # print(res)
        # print(res[2])
        X1, Y1, X2, Y2 = int(res[2][0][0]), int(res[2][0][1]), int(res[2][0][2]), int(res[2][0][3])
        ...
        for steps in range(step):
            ...
            for seeds in range(seed):
                ...
                print('res_inf[2] shape = ', res_inf[2].shape)
        ...
        for steps in range(step):
            ...
            for seeds in range(seed):
                ...
                shape_vis_adv, b3 = res_vis[2].shape
                ...
                print('res_vis[2] shape = ', res_vis[2].shape)
                ...
                conf_color[0][seeds] = res_vis[2][0][4]
