...
for net_id in range(0, 1):
    ...
    for pic in file:
        ...
        if res_inf1[0].shape[0] == 0 or res_vis1[0].shape[0] == 0:
            print(f"Skipping {pic}: No detection")
            continue
        ...
        # print(res)
        # print(res[2])
        X1, Y1, X2, Y2 = int(res[0][0][0]), int(res[0][0][1]), int(res[0][0][2]), int(res[0][0][3])
        ...
        for steps in range(step):
            ...
            for seeds in range(seed):
                ...
                print('res_inf shape = ', res_inf[0].shape if len(res_inf[0]) > 0 else (0, 5))
        ...
        for steps in range(step):
            ...
            for seeds in range(seed):
                ...
                shape_vis_adv, b3 = res_vis[0].shape
                ...
                print('res_vis shape = ', res_vis[0].shape if len(res_vis[0]) > 0 else (0, 5))
                ...
                conf_color[0][seeds] = res_vis[0][0][4]
